...
contract MyNFTBadgeCute is ERC1155, Ownable {
    string public name = "MY NFT – Attendance Badge (Cute Minimal)";
    string public symbol = "MYNFT-C";
    uint256 public constant BADGE = 1;
    constructor() ERC1155("ipfs://REPLACE_WITH_CUTE_METADATA_CID") {}
